...
const Prize: FC<PrizeProps> = ({ label, color = 'silver' }) => {
  // TODO: typography

  return (
    <div className="flex w-fit flex-row items-center justify-start rounded-r bg-white/80 p-[2px]">
      <svg
        width="20"
        height="18"
        viewBox="0 0 20 18"
      ...
      <div className="bold body-xs font-condensed uppercase">{label}</div>
    </div>
  )
}
