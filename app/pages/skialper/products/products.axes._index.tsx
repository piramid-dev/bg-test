...
export default function ProductsTypeIndex() {
  ...
  const productProps = useCardProps(products, family, 'axe')
  const filtersProps = prepareFilterProps(productProps, 'axe')
