...
export default function ProductsTypeIndex() {
  ...
  const productProps = useCardProps(products, family, 'splitboard_binding')
  const filtersProps = prepareFilterProps(productProps, 'splitboard_binding')
