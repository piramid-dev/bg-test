...
export default function ProductsTypeIndex() {
  ...
  const productProps = useCardProps(products, family, 'skin')
  const filtersProps = prepareFilterProps(productProps, 'skin')
