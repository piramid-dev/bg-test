...
export default function ProductsTypeIndex() {
  ...
  const productProps = useCardProps(products, family, 'splitboard')
  const filtersProps = prepareFilterProps(productProps, 'splitboard')
