...
export default function ProductsTypeIndex() {
  ...
  const productProps = useCardProps(products, family, 'shovel')
  const filtersProps = prepareFilterProps(productProps, 'shovel')
