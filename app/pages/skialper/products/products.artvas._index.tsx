...
export default function ProductsTypeIndex() {
  ...
  const productProps = useCardProps(products, family, 'artva')
  const filtersProps = prepareFilterProps(productProps, 'artva')
