...
export default function ProductsTypeIndex() {
  ...
  const productProps = useCardProps(products, family, 'backpack')
  const filtersProps = prepareFilterProps(productProps, 'backpack')
