...
export default function ProductsTypeIndex() {
  ...
  const productProps = useCardProps(products, family, 'crampon')
  const filtersProps = prepareFilterProps(productProps, 'crampon')
