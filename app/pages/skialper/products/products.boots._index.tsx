...
export default function ProductsTypeIndex() {
  ...
  const productProps = useCardProps(products, family, 'boot')
  const filtersProps = prepareFilterProps(productProps, 'boot')
