...
export default function ProductsTypeIndex() {
  ...
  const productProps = useCardProps(products, family, 'splitboard_boot')
  const filtersProps = prepareFilterProps(productProps, 'splitboard_boot')
